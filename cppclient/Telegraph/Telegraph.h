...
#define TEL_DEBUG_PRINTF0(format)    \
	sprintf(Telegraph::getInstance()->tele_handle->Text.pText ,format);    \
	Telegraph::getInstance()->textDisplay(Telegraph::getInstance()->tele_handle->Text.pText);

#define TEL_DEBUG_PRINTF1(format,arg1)    \
	sprintf(Telegraph::getInstance()->tele_handle->Text.pText,format,arg1);    \
	Telegraph::getInstance()->textDisplay(Telegraph::getInstance()->tele_handle->Text.pText);

#define TEL_DEBUG_PRINTF2(format,arg1,arg2)    \
	sprintf(Telegraph::getInstance()->tele_handle->Text.pText,format,arg1,arg2);    \
	Telegraph::getInstance()->textDisplay(Telegraph::getInstance()->tele_handle->Text.pText);

#define TEL_DEBUG_PRINTF3(format,arg1,arg2,arg3)    \
...
#define TEL_DEBUG_STOPWATCH_STOP(format)    \
	sprintf(tele_handle->Text.pText,format,TELE_Stopwatch_Stop());    \
	TELE_Text_Display(tele_handle->Text.pText );

#define TEL_DEBUG_DRAW_ADD(x,y,color)    \
	Telegraph::getInstance()->drawAdd(x,y,color);    \
 
#define TEL_DEBUG_DRAW_CLEAR()    \
	Telegraph::getInstance()->drawClear();    \
 
#define TEL_DEBUG_DRAW_DISPLAY()    \
	Telegraph::getInstance()->drawDisplay();
